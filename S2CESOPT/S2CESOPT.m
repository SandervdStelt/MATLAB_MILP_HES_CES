...
%% 
%Battery Specs
Batterysize = 3.626543209876543e+02;          % kWh
Soc0 = 50;                  % initial state of charge
Dt = 1;                     % time step
Cbat = 2;                   % battery capacity
Effd = 0.9;                 % battery efficiency discharge 
Effc = 0.9;                 % battery efficiency charge
Obj = 0;
...
Reqbattcap = [3.626543209876543e+02];
...
Pbatdmax = 300 .*(Sharegridinj);         % max boundary for battery discharge capacity for each house
Pbatcmax = 300 .*(Sharegridinj);         % max boundary for battery charge capacity for each house
...
PbatdTmax = 300;        % max boundary for battery discharge capacity total
PbatcTmax = 300;        % max boundary for battery charge capacity total
